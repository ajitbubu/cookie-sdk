...
export function buildStyles(theme?: Record<string, string>): string {
  ...
  * { box-sizing: border-box; font-family: var(--cc-font); }
  ...
  button {
    ...
    padding: 9px 16px; font-size: 14px; background: var(--cc-bg); color: var(--cc-fg);
  }
  ...
  .cc-cat-head button.cc-toggle-expand { border: none; background: none; font-size: 14px; flex: 1; text-align: left; }
