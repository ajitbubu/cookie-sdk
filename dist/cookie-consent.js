var N={bannerText:"We use cookies to improve your experience. Choose which categories to allow.",acceptAll:"Accept All",rejectAll:"Reject All",preferences:"Preferences",modalTitle:"Cookie Preferences",rejectNonEssential:"Reject Non-Essential",savePreferences:"Save Preferences",reopenButton:"Cookie settings",alwaysActive:"Always Active",close:"Close",viewCookies:"View Cookies",backToCategories:"Back to categories",searchPlaceholder:"Search cookies...",exportLabel:"Export",printLabel:"Print",resetToDefault:"Reset to Default",confirmChoices:"Confirm Choices",policyLinkText:"Read our Cookie Policy",gpcNotice:"Your browser sent a Global Privacy Control (GPC) signal, so we have defaulted marketing and ad-targeting cookies to off. Strictly necessary cookies remain active to keep the site working. You may still review and enable optional analytics or functional cookies below, or leave them disabled \u2014 your choice is saved and can be changed at any time.",gpcHonored:"Opt-Out Request Honored",noCookies:"No cookies in this category.",notAvailable:"N/A",columns:{name:"Cookie",provider:"Provider",domain:"Domain",expiry:"Expiry"},categoryNames:{necessary:"Strictly Necessary Cookies",analytics:"Performance / Analytics",functional:"Functional Cookies",marketing:"Marketing Cookies"},categoryDescriptions:{necessary:"These cookies are essential for the website to function and cannot be switched off. They are usually only set in response to actions made by you, such as setting your privacy preferences.",analytics:"These cookies allow us to count visits and traffic sources so we can measure and improve site performance.",functional:"These cookies enable enhanced functionality and personalisation.",marketing:"These cookies are used to build a profile of your interests and show relevant ads. Covers sale or sharing of personal data where applicable."}},T=["necessary","analytics","functional","marketing"];function I(){return{necessary:{enabled:!0,locked:!0,cookies:[]},analytics:{enabled:!1,cookies:[]},functional:{enabled:!1,cookies:[]},marketing:{enabled:!1,cookies:[]}}}var w={cookieName:"cc_consent",consentVersion:1,expiryDays:182,honorGpc:!0,gtm:{consentMode:!0,dataLayerEvent:"cookie_consent_update"}};function R(e){let n={...I(),...e.categories||{}};n.necessary={...n.necessary,enabled:!0,locked:!0};let t=e.position??{};return{cookieName:e.cookieName??w.cookieName,cookieDomain:e.cookieDomain,consentVersion:e.consentVersion??w.consentVersion,expiryDays:e.expiryDays??w.expiryDays,policyUrl:e.policyUrl,honorGpc:e.honorGpc??w.honorGpc,position:{banner:t.banner??"bottom",button:t.button??"bottom-left"},categories:n,gtm:{...w.gtm,...e.gtm||{}},labels:{...N,...e.labels||{},columns:{...N.columns,...e.labels?.columns||{}},categoryNames:{...N.categoryNames,...e.labels?.categoryNames||{}},categoryDescriptions:{...N.categoryDescriptions,...e.labels?.categoryDescriptions||{}}},theme:e.theme,onConsent:e.onConsent}}function V(e){let n={},t=e.getAttribute("data-cookie-name");t&&(n.cookieName=t);let o=e.getAttribute("data-cookie-domain");o&&(n.cookieDomain=o);let a=e.getAttribute("data-consent-version");a&&!Number.isNaN(Number(a))&&(n.consentVersion=Number(a));let i=e.getAttribute("data-expiry-days");i&&!Number.isNaN(Number(i))&&(n.expiryDays=Number(i));let r=e.getAttribute("data-policy-url");r&&(n.policyUrl=r);let c=e.getAttribute("data-consent-mode");c!=null&&(n.gtm={consentMode:c!=="false",dataLayerEvent:w.gtm.dataLayerEvent});let s=e.getAttribute("data-banner-position"),m=e.getAttribute("data-button-position");return(s==="top"||s==="bottom"||m)&&(n.position={},(s==="top"||s==="bottom")&&(n.position.banner=s),(m==="bottom-left"||m==="bottom-right"||m==="top-left"||m==="top-right")&&(n.position.button=m)),n.categories=I(),n}var G={necessary:[],analytics:["analytics_storage"],functional:["functionality_storage","personalization_storage"],marketing:["ad_storage","ad_user_data","ad_personalization"]},O=["ad_storage","ad_user_data","ad_personalization","analytics_storage","functionality_storage","personalization_storage"];function F(e){let n={};for(let t of O)n[t]="denied";return Object.keys(G).forEach(t=>{if(e[t])for(let o of G[t])n[o]="granted"}),n}function ne(e,n=document){let t=encodeURIComponent(e)+"=",o=n.cookie?n.cookie.split("; "):[];for(let a of o)if(a.indexOf(t)===0)return decodeURIComponent(a.slice(t.length));return null}function ae(e){if(!e)return null;let n;try{n=JSON.parse(e)}catch{return null}if(typeof n!="object"||n===null)return null;let t=n;if(t.schemaVersion!==1||typeof t.timestamp!="string"||typeof t.version!="number")return null;let o=t.categories;if(typeof o!="object"||o===null)return null;let a=["necessary","analytics","functional","marketing"];for(let i of a)if(typeof o[i]!="boolean")return null;return{schemaVersion:1,version:t.version,timestamp:t.timestamp,categories:{...o,necessary:!0}}}function M(e,n=document){return ae(ne(e,n))}var P={};function ce(e,n,t){return{schemaVersion:1,version:e.consentVersion,timestamp:t,categories:{...n,necessary:!0}}}function _(e,n=document,t=()=>new Date){function o(){return M(e.cookieName,n)??P[e.cookieName]??null}function a(r){let c=ce(e,r,t().toISOString()),s=encodeURIComponent(JSON.stringify(c)),m=e.expiryDays*24*60*60,u=`${encodeURIComponent(e.cookieName)}=${s}; Max-Age=${m}; Path=/; SameSite=Lax`;e.cookieDomain&&(u+=`; Domain=${e.cookieDomain}`),typeof location<"u"&&location.protocol==="https:"&&(u+="; Secure");try{n.cookie=u,M(e.cookieName,n)===null&&(P[e.cookieName]=c,$())}catch{P[e.cookieName]=c,$()}return c}function i(){let r=o();return!r||r.version<e.consentVersion}return{read:o,write:a,needsPrompt:i}}var U=!1;function $(){!U&&typeof console<"u"&&(U=!0,console.warn("[cookie-banner-sdk] cookie write blocked; consent kept in memory for this session only."))}function ie(){return typeof window<"u"?window:void 0}function se(e){return e.dataLayer=e.dataLayer||[],e.gtag||(e.gtag=function(){e.dataLayer.push(arguments)}),e.gtag}function Y(e,n){let t=ie();e.gtm.consentMode&&t&&se(t)("consent","update",F(n)),e.gtm.consentMode&&t&&Array.isArray(t.dataLayer)&&t.dataLayer.push({event:e.gtm.dataLayerEvent,consent:{...n}}),typeof e.onConsent=="function"&&e.onConsent({...n})}function D(e){return`
  ...
  * { box-sizing: border-box; font-family: var(--cc-font); }
  ...
  `}function W(e){let n=document.createElement("div");n.setAttribute("data-cookie-consent-root","");let t=n.attachShadow({mode:"open"}),o=document.createElement("style");return o.textContent=D(e),t.appendChild(o),document.body.appendChild(n),{host:n,root:t,setTheme(a){o.textContent=D(a)},destroy(){n.remove()}}}function q(e,n){let t=document.createElement("div");t.className="cc-banner",t.setAttribute("role","dialog"),t.setAttribute("aria-label",e.modalTitle),t.setAttribute("aria-live","polite");let o=document.createElement("p");o.textContent=e.bannerText,t.appendChild(o);let a=document.createElement("div");a.className="cc-actions";let i=H(e.preferences,n.onPreferences,"cc-secondary"),r=H(e.rejectAll,n.onRejectAll,"cc-primary"),c=H(e.acceptAll,n.onAcceptAll,"cc-primary");return a.append(i,r,c),t.appendChild(a),t}function H(e,n,t){let o=document.createElement("button");return o.type="button",o.textContent=e,t&&(o.className=t),o.addEventListener("click",n),o}var z="http://www.w3.org/2000/svg";function le(){let e=document.createElementNS(z,"svg");e.setAttribute("viewBox","0 0 24 24"),e.setAttribute("width","22"),e.setAttribute("height","22"),e.setAttribute("fill","none"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","1.8"),e.setAttribute("aria-hidden","true");let n=document.createElementNS(z,"path");n.setAttribute("d","M12 2a10 10 0 1 0 10 10 4 4 0 0 1-4-4 4 4 0 0 1-4-4 2 2 0 0 0-2-2z"),e.appendChild(n);for(let[t,o]of[[9,9],[14,12],[10,15]]){let a=document.createElementNS(z,"circle");a.setAttribute("cx",String(t)),a.setAttribute("cy",String(o)),a.setAttribute("r","1"),a.setAttribute("fill","currentColor"),a.setAttribute("stroke","none"),e.appendChild(a)}return e}function J(e,n){let t=document.createElement("button");return t.type="button",t.className="cc-fab",t.setAttribute("aria-label",e.reopenButton),t.title=e.reopenButton,t.appendChild(le()),t.addEventListener("click",n),t}var X="http://www.w3.org/2000/svg";function E(e,n={}){let t=document.createElementNS(X,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","18"),t.setAttribute("height","18"),t.setAttribute("fill",n.fill?"currentColor":"none"),t.setAttribute("stroke",n.fill?"none":"currentColor"),t.setAttribute("stroke-width","1.8"),t.setAttribute("stroke-linecap","round"),t.setAttribute("stroke-linejoin","round"),t.setAttribute("aria-hidden","true");for(let o of e){let a=document.createElementNS(X,"path");a.setAttribute("d",o),t.appendChild(a)}return t}var S={gear:()=>E(["M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z","M19.4 13.5a1.7 1.7 0 0 0 .3 1.9l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-2.9 1.2V21a2 2 0 0 1-4 0v-.2a1.7 1.7 0 0 0-2.9-1.1l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0-1.2-2.9H3a2 2 0 0 1 0-4h.2a1.7 1.7 0 0 0 1.1-2.9l-.1-.1A2 2 0 1 1 7 4.2l.1.1a1.7 1.7 0 0 0 1.9.3 1.7 1.7 0 0 0 1-1.6V3a2 2 0 0 1 4 0v.2a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.9-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1H21a2 2 0 0 1 0 4h-.2a1.7 1.7 0 0 0-1.4 1z"]),check:()=>E(["M20 6 9 17l-5-5"]),back:()=>E(["M19 12H5","M12 19l-7-7 7-7"]),exportIcon:()=>E(["M12 3v12","M8 7l4-4 4 4","M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"]),print:()=>E(["M6 9V2h12v7","M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2","M6 14h12v8H6z"])};function Z(e,n,t,o){let a=e.labels,i={},r=document.createElement("div");r.className="cc-overlay",r.addEventListener("click",p=>{p.target===r&&o.onClose()});let c=document.createElement("div");c.className="cc-modal",c.setAttribute("role","dialog"),c.setAttribute("aria-modal","true"),c.setAttribute("aria-label",a.modalTitle);let s=document.createElement("div");s.className="cc-modal-header";let m=document.createElement("div");m.className="cc-title",m.append(S.gear(),h("h2",a.modalTitle));let u=document.createElement("button");u.type="button",u.className="cc-close",u.setAttribute("aria-label",a.close),u.append(h("span","\u2715","cc-close-x")),u.addEventListener("click",o.onClose),s.append(m,u),c.appendChild(s);let d=document.createElement("div");if(d.className="cc-panel cc-panel-categories",t){let p=document.createElement("p");if(p.className="cc-gpc-notice",p.textContent=a.gpcNotice+" ",e.policyUrl){let f=document.createElement("a");f.href=e.policyUrl,f.target="_blank",f.rel="noopener",f.textContent=a.policyLinkText,p.appendChild(f)}d.appendChild(p);let l=document.createElement("div");l.className="cc-gpc-honored",l.setAttribute("role","status"),l.append(S.check(),h("span",a.gpcHonored)),d.appendChild(l)}else if(e.policyUrl){let p=document.createElement("p");p.className="cc-gpc-notice",p.textContent=a.bannerText+" ";let l=document.createElement("a");l.href=e.policyUrl,l.target="_blank",l.rel="noopener",l.textContent=a.policyLinkText,p.appendChild(l),d.appendChild(p)}for(let p of T){let l=e.categories[p];l&&d.appendChild(de(p,l,e,n,i,k))}c.appendChild(d);let y=document.createElement("div");y.className="cc-panel cc-panel-detail",y.hidden=!0,c.appendChild(y);let g=document.createElement("div");g.className="cc-modal-actions",g.append(A(a.rejectNonEssential,o.onRejectNonEssential,"cc-secondary"),A(a.acceptAll,o.onAcceptAll,"cc-primary"),A(a.savePreferences,()=>o.onSave(v()),"cc-primary")),c.appendChild(g);let b=document.createElement("div");b.className="cc-modal-actions",b.hidden=!0,b.append(A(a.resetToDefault,C,"cc-secondary"),A(a.confirmChoices,()=>o.onSave(v()),"cc-primary")),c.appendChild(b);function v(){return{necessary:!0,analytics:i.analytics?.checked??!1,functional:i.functional?.checked??!1,marketing:i.marketing?.checked??!1}}function C(){Object.keys(i).forEach(p=>{let l=i[p];l&&(l.checked=e.categories[p]?.enabled??!1)})}function x(){y.hidden=!0,b.hidden=!0,d.hidden=!1,g.hidden=!1}function k(p){y.replaceChildren(ue(p,e,x)),d.hidden=!0,g.hidden=!0,y.hidden=!1,b.hidden=!1}return r.appendChild(c),{overlay:r,dialog:c}}function de(e,n,t,o,a,i){let r=t.labels,c=document.createElement("div");c.className="cc-card";let s=document.createElement("div");if(s.className="cc-card-head",s.appendChild(h("h3",r.categoryNames[e])),n.locked){let d=document.createElement("span");d.className="cc-badge",d.textContent=r.alwaysActive,s.appendChild(d)}else s.appendChild(pe(e,o[e],r.categoryNames[e],a));c.appendChild(s);let m=document.createElement("p");m.className="cc-card-desc",m.textContent=n.description??r.categoryDescriptions[e],c.appendChild(m);let u=document.createElement("button");return u.type="button",u.className="cc-view-link",u.textContent=r.viewCookies,u.addEventListener("click",()=>i(e)),c.appendChild(u),c}function pe(e,n,t,o){let a=document.createElement("label");a.className="cc-switch";let i=document.createElement("input");i.type="checkbox",i.checked=n,i.setAttribute("aria-label",t);let r=document.createElement("span");return r.className="cc-slider",a.append(i,r),o[e]=i,a}function ue(e,n,t){let o=n.labels,a=n.categories[e],i=document.createElement("div"),r=document.createElement("button");r.type="button",r.className="cc-back",r.append(S.back(),h("span",o.backToCategories)),r.addEventListener("click",t),i.appendChild(r),i.appendChild(h("h3",o.categoryNames[e],"cc-detail-title")),i.appendChild(h("p",a.description??o.categoryDescriptions[e],"cc-detail-desc"));let c=document.createElement("div");c.className="cc-toolbar";let s=document.createElement("input");s.type="search",s.className="cc-search",s.placeholder=o.searchPlaceholder,s.setAttribute("aria-label",o.searchPlaceholder);let m=Q(o.exportLabel,S.exportIcon(),()=>fe(e,n)),u=Q(o.printLabel,S.print(),()=>ge(e,n));c.append(s,m,u),i.appendChild(c);let d=document.createElement("table");d.className="cc-table";let y=document.createElement("thead"),g=document.createElement("tr");[o.columns.name,o.columns.provider,o.columns.domain,o.columns.expiry].forEach(x=>g.appendChild(h("th",x))),y.appendChild(g);let b=document.createElement("tbody");function v(x){b.replaceChildren();let k=x.trim().toLowerCase(),p=a.cookies.filter(l=>!k||[l.name,l.provider,l.domain,l.purpose].some(f=>(f||"").toLowerCase().includes(k)));if(p.length===0){let l=document.createElement("tr"),f=h("td",n.labels.noCookies);f.setAttribute("colspan","4"),f.className="cc-empty-row",l.appendChild(f),b.appendChild(l);return}for(let l of p){let f=document.createElement("tr");f.append(h("td",l.name,"cc-cell-name"),h("td",l.provider||o.notAvailable),h("td",l.domain||o.notAvailable),h("td",l.duration||o.notAvailable)),b.appendChild(f)}}v(""),s.addEventListener("input",()=>v(s.value)),d.append(y,b);let C=document.createElement("div");return C.className="cc-table-scroll",C.appendChild(d),i.appendChild(C),i}function me(e,n){let t=n.labels,o=[t.columns.name,t.columns.provider,t.columns.domain,t.columns.expiry,"Purpose"],a=r=>`"${String(r).replace(/"/g,'""')}"`,i=[o.map(a).join(",")];for(let r of n.categories[e].cookies)i.push([r.name,r.provider||t.notAvailable,r.domain||t.notAvailable,r.duration||t.notAvailable,r.purpose||t.notAvailable].map(a).join(","));return i.join(`
`)}function fe(e,n){try{let t=new Blob([me(e,n)],{type:"text/csv;charset=utf-8"}),o=URL.createObjectURL(t),a=document.createElement("a");a.href=o,a.download=`cookies-${e}.csv`,a.click(),URL.revokeObjectURL(o)}catch{}}function ge(e,n){let t=n.labels,o=window.open("","_blank","width=720,height=600");if(!o)return;let a=o.document;a.title=`${t.categoryNames[e]} \u2014 cookies`;let i=a.createElement("h2");i.textContent=t.categoryNames[e];let r=a.createElement("table");r.setAttribute("border","1"),r.style.borderCollapse="collapse";let c=a.createElement("thead"),s=a.createElement("tr");[t.columns.name,t.columns.provider,t.columns.domain,t.columns.expiry].forEach(u=>{let d=a.createElement("th");d.textContent=u,d.style.padding="6px 10px",s.appendChild(d)}),c.appendChild(s);let m=a.createElement("tbody");for(let u of n.categories[e].cookies){let d=a.createElement("tr");[u.name,u.provider||t.notAvailable,u.domain||t.notAvailable,u.duration||t.notAvailable].forEach(y=>{let g=a.createElement("td");g.textContent=y,g.style.padding="6px 10px",d.appendChild(g)}),m.appendChild(d)}r.append(c,m),a.body.append(i,r),o.focus(),o.print()}function h(e,n,t){let o=document.createElement(e);return o.textContent=n,t&&(o.className=t),o}function A(e,n,t){let o=document.createElement("button");return o.type="button",o.textContent=e,t&&(o.className=t),o.addEventListener("click",n),o}function Q(e,n,t){let o=document.createElement("button");return o.type="button",o.className="cc-icon-btn",o.append(n,h("span",e)),o.addEventListener("click",t),o}var be='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';function ee(e,n,t){let o=n.activeElement;function a(){return Array.from(e.querySelectorAll(be)).filter(c=>c.offsetParent!==null||c===n.activeElement)}function i(c){if(c.key==="Escape"){c.preventDefault(),t();return}if(c.key!=="Tab")return;let s=a();if(s.length===0){c.preventDefault();return}let m=s[0],u=s[s.length-1],d=n.activeElement;c.shiftKey&&(d===m||!e.contains(d))?(c.preventDefault(),u.focus()):!c.shiftKey&&d===u&&(c.preventDefault(),m.focus())}e.addEventListener("keydown",i);let r=a();return r.length>0&&r[0].focus(),{release(){e.removeEventListener("keydown",i),o&&typeof o.focus=="function"&&o.focus()}}}function j(e=typeof navigator<"u"?navigator:void 0){return e?e.globalPrivacyControl===!0:!1}var L="__cookieConsentInitialized",ye=new Set(["--cc-bg","--cc-fg","--cc-muted","--cc-border","--cc-surface","--cc-accent","--cc-accent-fg","--cc-success","--cc-success-bg","--cc-success-border","--cc-radius","--cc-font","--cc-font-size","--cc-heading-color","--cc-heading-size","--cc-z"]);function B(e){console.warn(`[cookie-banner-sdk] ${e} See https://github.com/ajitbubu/cookie-sdk#configuration`)}function he(e,n){let t=["analytics","functional","marketing"].filter(o=>(n.categories[o]?.cookies?.length??0)>0);(!e.categories||t.length===0)&&B("no optional cookie categories are configured \u2014 the preferences modal will only show 'Strictly Necessary'. Pass `categories` with the cookies your site sets.");for(let o of Object.keys(n.theme??{})){let a=o.startsWith("--cc-")?o:`--cc-${o.replace(/^--/,"")}`;ye.has(a)||B(`theme key "${o}" is not a recognized --cc-* variable and will have no effect.`)}}function te(){return{necessary:!0,analytics:!0,functional:!0,marketing:!0}}function oe(){return{necessary:!0,analytics:!1,functional:!1,marketing:!1}}function K(e){let n=window;if(n[L])return B("init() called more than once \u2014 ignoring this call and returning the existing instance. Call destroy() first if you mean to re-initialize."),n[L];let t=R(e);he(e,t);let o=t.honorGpc&&j(),a=_(t),i=W(t.theme),r=null,c=null,s=null,m=null;function u(){return{necessary:!0,analytics:t.categories.analytics?.enabled??!1,functional:t.categories.functional?.enabled??!1,marketing:o?!1:t.categories.marketing?.enabled??!1}}function d(p){a.write(p),Y(t,p),g(),C(),b()}function y(p=!0){r||(r=q(t.labels,{onAcceptAll:()=>d(te()),onRejectAll:()=>d(oe()),onPreferences:v}),r.classList.add(`cc-pos-${t.position.banner}`),p||r.classList.add("cc-no-anim"),i.root.appendChild(r))}function g(){r?.remove(),r=null}function b(){c||(c=J(t.labels,v),c.classList.add(`cc-fab-${t.position.button}`),i.root.appendChild(c))}function v(){if(s)return;let p=a.read()?.categories??u(),l=Z(t,p,o,{onAcceptAll:()=>d(te()),onRejectNonEssential:()=>d(oe()),onSave:f=>d(f),onClose:C});s=l.overlay,i.root.appendChild(s),r&&(r.setAttribute("inert",""),r.setAttribute("aria-hidden","true")),m=ee(l.dialog,i.root,C)}function C(){m?.release(),m=null,s?.remove(),s=null,r&&(r.removeAttribute("inert"),r.removeAttribute("aria-hidden"))}a.needsPrompt()?y():b();function x(p){t=R(p),o=t.honorGpc&&j(),a=_(t),i.setTheme(t.theme);let l=!!s;C(),g(),c?.remove(),c=null,a.needsPrompt()?y(!1):b(),l&&v()}let k={destroy(){C(),i.destroy(),delete n[L]},openPreferences:v,getConsent(){return a.read()?.categories??null},update:x};return n[L]=k,k}function Ce(){if(typeof document>"u")return;let e=document.currentScript??document.querySelector("script[data-auto-init]");e&&e.hasAttribute("data-auto-init")&&K(V(e))}typeof window<"u"&&(window.CookieConsent={init:K},Ce());export{K as init};
