var N={bannerText:"We use cookies to improve your experience. Choose which categories to allow.",acceptAll:"Accept All",rejectAll:"Reject All",preferences:"Preferences",modalTitle:"Cookie Preferences",rejectNonEssential:"Reject Non-Essential",savePreferences:"Save Preferences",reopenButton:"Cookie settings",alwaysActive:"Always Active",close:"Close",viewCookies:"View Cookies",backToCategories:"Back to categories",searchPlaceholder:"Search cookies...",exportLabel:"Export",printLabel:"Print",resetToDefault:"Reset to Default",confirmChoices:"Confirm Choices",policyLinkText:"Read our Cookie Policy",gpcNotice:"Your browser sent a Global Privacy Control (GPC) signal, so we have defaulted marketing and ad-targeting cookies to off. Strictly necessary cookies remain active to keep the site working. You may still review and enable optional analytics or functional cookies below, or leave them disabled \u2014 your choice is saved and can be changed at any time.",gpcHonored:"Opt-Out Request Honored",noCookies:"No cookies in this category.",notAvailable:"N/A",columns:{name:"Cookie",provider:"Provider",domain:"Domain",expiry:"Expiry"},categoryNames:{necessary:"Strictly Necessary Cookies",analytics:"Performance / Analytics",functional:"Functional Cookies",marketing:"Marketing Cookies"},categoryDescriptions:{necessary:"These cookies are essential for the website to function and cannot be switched off. They are usually only set in response to actions made by you, such as setting your privacy preferences.",analytics:"These cookies allow us to count visits and traffic sources so we can measure and improve site performance.",functional:"These cookies enable enhanced functionality and personalisation.",marketing:"These cookies are used to build a profile of your interests and show relevant ads. Covers sale or sharing of personal data where applicable."}},T=["necessary","analytics","functional","marketing"];function P(){return{necessary:{enabled:!0,locked:!0,cookies:[]},analytics:{enabled:!1,cookies:[]},functional:{enabled:!1,cookies:[]},marketing:{enabled:!1,cookies:[]}}}var w={cookieName:"cc_consent",consentVersion:1,expiryDays:182,honorGpc:!0,gtm:{consentMode:!0,dataLayerEvent:"cookie_consent_update"}};function z(e){let o={...P(),...e.categories||{}};return o.necessary={...o.necessary,enabled:!0,locked:!0},{cookieName:e.cookieName??w.cookieName,cookieDomain:e.cookieDomain,consentVersion:e.consentVersion??w.consentVersion,expiryDays:e.expiryDays??w.expiryDays,policyUrl:e.policyUrl,honorGpc:e.honorGpc??w.honorGpc,categories:o,gtm:{...w.gtm,...e.gtm||{}},labels:{...N,...e.labels||{},columns:{...N.columns,...e.labels?.columns||{}},categoryNames:{...N.categoryNames,...e.labels?.categoryNames||{}},categoryDescriptions:{...N.categoryDescriptions,...e.labels?.categoryDescriptions||{}}},theme:e.theme,onConsent:e.onConsent}}function K(e){let o={},t=e.getAttribute("data-cookie-name");t&&(o.cookieName=t);let n=e.getAttribute("data-cookie-domain");n&&(o.cookieDomain=n);let a=e.getAttribute("data-consent-version");a&&!Number.isNaN(Number(a))&&(o.consentVersion=Number(a));let i=e.getAttribute("data-expiry-days");i&&!Number.isNaN(Number(i))&&(o.expiryDays=Number(i));let r=e.getAttribute("data-policy-url");r&&(o.policyUrl=r);let c=e.getAttribute("data-consent-mode");return c!=null&&(o.gtm={consentMode:c!=="false",dataLayerEvent:w.gtm.dataLayerEvent}),o.categories=P(),o}var j={necessary:[],analytics:["analytics_storage"],functional:["functionality_storage","personalization_storage"],marketing:["ad_storage","ad_user_data","ad_personalization"]},B=["ad_storage","ad_user_data","ad_personalization","analytics_storage","functionality_storage","personalization_storage"];function I(e){let o={};for(let t of B)o[t]="denied";return Object.keys(j).forEach(t=>{if(e[t])for(let n of j[t])o[n]="granted"}),o}function oe(e,o=document){let t=encodeURIComponent(e)+"=",n=o.cookie?o.cookie.split("; "):[];for(let a of n)if(a.indexOf(t)===0)return decodeURIComponent(a.slice(t.length));return null}function ne(e){if(!e)return null;let o;try{o=JSON.parse(e)}catch{return null}if(typeof o!="object"||o===null)return null;let t=o;if(t.schemaVersion!==1||typeof t.timestamp!="string"||typeof t.version!="number")return null;let n=t.categories;if(typeof n!="object"||n===null)return null;let a=["necessary","analytics","functional","marketing"];for(let i of a)if(typeof n[i]!="boolean")return null;return{schemaVersion:1,version:t.version,timestamp:t.timestamp,categories:{...n,necessary:!0}}}function R(e,o=document){return ne(oe(e,o))}var M={};function re(e,o,t){return{schemaVersion:1,version:e.consentVersion,timestamp:t,categories:{...o,necessary:!0}}}function O(e,o=document,t=()=>new Date){function n(){return R(e.cookieName,o)??M[e.cookieName]??null}function a(r){let c=re(e,r,t().toISOString()),s=encodeURIComponent(JSON.stringify(c)),m=e.expiryDays*24*60*60,p=`${encodeURIComponent(e.cookieName)}=${s}; Max-Age=${m}; Path=/; SameSite=Lax`;e.cookieDomain&&(p+=`; Domain=${e.cookieDomain}`),typeof location<"u"&&location.protocol==="https:"&&(p+="; Secure");try{o.cookie=p,R(e.cookieName,o)===null&&(M[e.cookieName]=c,G())}catch{M[e.cookieName]=c,G()}return c}function i(){let r=n();return!r||r.version<e.consentVersion}return{read:n,write:a,needsPrompt:i}}var V=!1;function G(){!V&&typeof console<"u"&&(V=!0,console.warn("[cookie-banner-sdk] cookie write blocked; consent kept in memory for this session only."))}function ce(){return typeof window<"u"?window:void 0}function ie(e){return e.dataLayer=e.dataLayer||[],e.gtag||(e.gtag=function(){e.dataLayer.push(arguments)}),e.gtag}function F(e,o){let t=ce();e.gtm.consentMode&&t&&ie(t)("consent","update",I(o)),e.gtm.consentMode&&t&&Array.isArray(t.dataLayer)&&t.dataLayer.push({event:e.gtm.dataLayerEvent,consent:{...o}}),typeof e.onConsent=="function"&&e.onConsent({...o})}function U(e){return`
  ...
  * { box-sizing: border-box; font-family: var(--cc-font); }
  ...
  `}function Y(e){let o=document.createElement("div");o.setAttribute("data-cookie-consent-root","");let t=o.attachShadow({mode:"open"}),n=document.createElement("style");return n.textContent=U(e),t.appendChild(n),document.body.appendChild(o),{host:o,root:t,destroy(){o.remove()}}}function $(e,o){let t=document.createElement("div");t.className="cc-banner",t.setAttribute("role","dialog"),t.setAttribute("aria-label",e.modalTitle),t.setAttribute("aria-live","polite");let n=document.createElement("p");n.textContent=e.bannerText,t.appendChild(n);let a=document.createElement("div");a.className="cc-actions";let i=_(e.preferences,o.onPreferences,"cc-tertiary"),r=_(e.rejectAll,o.onRejectAll,"cc-primary"),c=_(e.acceptAll,o.onAcceptAll,"cc-primary");return a.append(i,r,c),t.appendChild(a),t}function _(e,o,t){let n=document.createElement("button");return n.type="button",n.textContent=e,t&&(n.className=t),n.addEventListener("click",o),n}var D="http://www.w3.org/2000/svg";function se(){let e=document.createElementNS(D,"svg");e.setAttribute("viewBox","0 0 24 24"),e.setAttribute("width","22"),e.setAttribute("height","22"),e.setAttribute("fill","none"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","1.8"),e.setAttribute("aria-hidden","true");let o=document.createElementNS(D,"path");o.setAttribute("d","M12 2a10 10 0 1 0 10 10 4 4 0 0 1-4-4 4 4 0 0 1-4-4 2 2 0 0 0-2-2z"),e.appendChild(o);for(let[t,n]of[[9,9],[14,12],[10,15]]){let a=document.createElementNS(D,"circle");a.setAttribute("cx",String(t)),a.setAttribute("cy",String(n)),a.setAttribute("r","1"),a.setAttribute("fill","currentColor"),a.setAttribute("stroke","none"),e.appendChild(a)}return e}function W(e,o){let t=document.createElement("button");return t.type="button",t.className="cc-fab",t.setAttribute("aria-label",e.reopenButton),t.title=e.reopenButton,t.appendChild(se()),t.addEventListener("click",o),t}var q="http://www.w3.org/2000/svg";function E(e,o={}){let t=document.createElementNS(q,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","18"),t.setAttribute("height","18"),t.setAttribute("fill",o.fill?"currentColor":"none"),t.setAttribute("stroke",o.fill?"none":"currentColor"),t.setAttribute("stroke-width","1.8"),t.setAttribute("stroke-linecap","round"),t.setAttribute("stroke-linejoin","round"),t.setAttribute("aria-hidden","true");for(let n of e){let a=document.createElementNS(q,"path");a.setAttribute("d",n),t.appendChild(a)}return t}var S={gear:()=>E(["M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z","M19.4 13.5a1.7 1.7 0 0 0 .3 1.9l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-2.9 1.2V21a2 2 0 0 1-4 0v-.2a1.7 1.7 0 0 0-2.9-1.1l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0-1.2-2.9H3a2 2 0 0 1 0-4h.2a1.7 1.7 0 0 0 1.1-2.9l-.1-.1A2 2 0 1 1 7 4.2l.1.1a1.7 1.7 0 0 0 1.9.3 1.7 1.7 0 0 0 1-1.6V3a2 2 0 0 1 4 0v.2a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.9-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1H21a2 2 0 0 1 0 4h-.2a1.7 1.7 0 0 0-1.4 1z"]),check:()=>E(["M20 6 9 17l-5-5"]),back:()=>E(["M19 12H5","M12 19l-7-7 7-7"]),exportIcon:()=>E(["M12 3v12","M8 7l4-4 4 4","M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"]),print:()=>E(["M6 9V2h12v7","M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2","M6 14h12v8H6z"])};function X(e,o,t,n){let a=e.labels,i={},r=document.createElement("div");r.className="cc-overlay",r.addEventListener("click",u=>{u.target===r&&n.onClose()});let c=document.createElement("div");c.className="cc-modal",c.setAttribute("role","dialog"),c.setAttribute("aria-modal","true"),c.setAttribute("aria-label",a.modalTitle);let s=document.createElement("div");s.className="cc-modal-header";let m=document.createElement("div");m.className="cc-title",m.append(S.gear(),g("h2",a.modalTitle));let p=document.createElement("button");p.type="button",p.className="cc-close",p.setAttribute("aria-label",a.close),p.append(g("span",a.close),g("span","\u2715","cc-close-x")),p.addEventListener("click",n.onClose),s.append(m,p),c.appendChild(s);let l=document.createElement("div");if(l.className="cc-panel cc-panel-categories",t){let u=document.createElement("p");if(u.className="cc-gpc-notice",u.textContent=a.gpcNotice+" ",e.policyUrl){let y=document.createElement("a");y.href=e.policyUrl,y.target="_blank",y.rel="noopener",y.textContent=a.policyLinkText,u.appendChild(y)}l.appendChild(u);let d=document.createElement("div");d.className="cc-gpc-honored",d.setAttribute("role","status"),d.append(S.check(),g("span",a.gpcHonored)),l.appendChild(d)}else if(e.policyUrl){let u=document.createElement("p");u.className="cc-gpc-notice",u.textContent=a.bannerText+" ";let d=document.createElement("a");d.href=e.policyUrl,d.target="_blank",d.rel="noopener",d.textContent=a.policyLinkText,u.appendChild(d),l.appendChild(u)}for(let u of T){let d=e.categories[u];d&&l.appendChild(le(u,d,e,o,i,x))}c.appendChild(l);let C=document.createElement("div");C.className="cc-panel cc-panel-detail",C.hidden=!0,c.appendChild(C);let f=document.createElement("div");f.className="cc-modal-actions",f.append(A(a.rejectNonEssential,n.onRejectNonEssential,"cc-secondary"),A(a.acceptAll,n.onAcceptAll,"cc-primary"),A(a.savePreferences,()=>n.onSave(v()),"cc-primary")),c.appendChild(f);let b=document.createElement("div");b.className="cc-modal-actions",b.hidden=!0,b.append(A(a.resetToDefault,h,"cc-secondary"),A(a.confirmChoices,()=>n.onSave(v()),"cc-primary")),c.appendChild(b);function v(){return{necessary:!0,analytics:i.analytics?.checked??!1,functional:i.functional?.checked??!1,marketing:i.marketing?.checked??!1}}function h(){Object.keys(i).forEach(u=>{let d=i[u];d&&(d.checked=e.categories[u]?.enabled??!1)})}function k(){C.hidden=!0,b.hidden=!0,l.hidden=!1,f.hidden=!1}function x(u){C.replaceChildren(pe(u,e,k)),l.hidden=!0,f.hidden=!0,C.hidden=!1,b.hidden=!1}return r.appendChild(c),{overlay:r,dialog:c}}function le(e,o,t,n,a,i){let r=t.labels,c=document.createElement("div");c.className="cc-card";let s=document.createElement("div");if(s.className="cc-card-head",s.appendChild(g("h3",r.categoryNames[e])),o.locked){let l=document.createElement("span");l.className="cc-badge",l.textContent=r.alwaysActive,s.appendChild(l)}else s.appendChild(de(e,n[e],r.categoryNames[e],a));c.appendChild(s);let m=document.createElement("p");m.className="cc-card-desc",m.textContent=o.description??r.categoryDescriptions[e],c.appendChild(m);let p=document.createElement("button");return p.type="button",p.className="cc-view-link",p.textContent=r.viewCookies,p.addEventListener("click",()=>i(e)),c.appendChild(p),c}function de(e,o,t,n){let a=document.createElement("label");a.className="cc-switch";let i=document.createElement("input");i.type="checkbox",i.checked=o,i.setAttribute("aria-label",t);let r=document.createElement("span");return r.className="cc-slider",a.append(i,r),n[e]=i,a}function pe(e,o,t){let n=o.labels,a=o.categories[e],i=document.createElement("div"),r=document.createElement("button");r.type="button",r.className="cc-back",r.append(S.back(),g("span",n.backToCategories)),r.addEventListener("click",t),i.appendChild(r),i.appendChild(g("h3",n.categoryNames[e],"cc-detail-title")),i.appendChild(g("p",a.description??n.categoryDescriptions[e],"cc-detail-desc"));let c=document.createElement("div");c.className="cc-toolbar";let s=document.createElement("input");s.type="search",s.className="cc-search",s.placeholder=n.searchPlaceholder,s.setAttribute("aria-label",n.searchPlaceholder);let m=J(n.exportLabel,S.exportIcon(),()=>me(e,o)),p=J(n.printLabel,S.print(),()=>ge(e,o));c.append(s,m,p),i.appendChild(c);let l=document.createElement("table");l.className="cc-table";let C=document.createElement("thead"),f=document.createElement("tr");[n.columns.name,n.columns.provider,n.columns.domain,n.columns.expiry].forEach(k=>f.appendChild(g("th",k))),C.appendChild(f);let b=document.createElement("tbody");function v(k){b.replaceChildren();let x=k.trim().toLowerCase(),u=a.cookies.filter(d=>!x||[d.name,d.provider,d.domain,d.purpose].some(y=>(y||"").toLowerCase().includes(x)));if(u.length===0){let d=document.createElement("tr"),y=g("td",o.labels.noCookies);y.setAttribute("colspan","4"),y.className="cc-empty-row",d.appendChild(y),b.appendChild(d);return}for(let d of u){let y=document.createElement("tr");y.append(g("td",d.name,"cc-cell-name"),g("td",d.provider||n.notAvailable),g("td",d.domain||n.notAvailable),g("td",d.duration||n.notAvailable)),b.appendChild(y)}}v(""),s.addEventListener("input",()=>v(s.value)),l.append(C,b);let h=document.createElement("div");return h.className="cc-table-scroll",h.appendChild(l),i.appendChild(h),i}function ue(e,o){let t=o.labels,n=[t.columns.name,t.columns.provider,t.columns.domain,t.columns.expiry,"Purpose"],a=r=>`"${String(r).replace(/"/g,'""')}"`,i=[n.map(a).join(",")];for(let r of o.categories[e].cookies)i.push([r.name,r.provider||t.notAvailable,r.domain||t.notAvailable,r.duration||t.notAvailable,r.purpose||t.notAvailable].map(a).join(","));return i.join(`
`)}function me(e,o){try{let t=new Blob([ue(e,o)],{type:"text/csv;charset=utf-8"}),n=URL.createObjectURL(t),a=document.createElement("a");a.href=n,a.download=`cookies-${e}.csv`,a.click(),URL.revokeObjectURL(n)}catch{}}function ge(e,o){let t=o.labels,n=window.open("","_blank","width=720,height=600");if(!n)return;let a=n.document;a.title=`${t.categoryNames[e]} \u2014 cookies`;let i=a.createElement("h2");i.textContent=t.categoryNames[e];let r=a.createElement("table");r.setAttribute("border","1"),r.style.borderCollapse="collapse";let c=a.createElement("thead"),s=a.createElement("tr");[t.columns.name,t.columns.provider,t.columns.domain,t.columns.expiry].forEach(p=>{let l=a.createElement("th");l.textContent=p,l.style.padding="6px 10px",s.appendChild(l)}),c.appendChild(s);let m=a.createElement("tbody");for(let p of o.categories[e].cookies){let l=a.createElement("tr");[p.name,p.provider||t.notAvailable,p.domain||t.notAvailable,p.duration||t.notAvailable].forEach(C=>{let f=a.createElement("td");f.textContent=C,f.style.padding="6px 10px",l.appendChild(f)}),m.appendChild(l)}r.append(c,m),a.body.append(i,r),n.focus(),n.print()}function g(e,o,t){let n=document.createElement(e);return n.textContent=o,t&&(n.className=t),n}function A(e,o,t){let n=document.createElement("button");return n.type="button",n.textContent=e,t&&(n.className=t),n.addEventListener("click",o),n}function J(e,o,t){let n=document.createElement("button");return n.type="button",n.className="cc-icon-btn",n.append(o,g("span",e)),n.addEventListener("click",t),n}var fe='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';function Q(e,o,t){let n=o.activeElement;function a(){return Array.from(e.querySelectorAll(fe)).filter(c=>c.offsetParent!==null||c===o.activeElement)}function i(c){if(c.key==="Escape"){c.preventDefault(),t();return}if(c.key!=="Tab")return;let s=a();if(s.length===0){c.preventDefault();return}let m=s[0],p=s[s.length-1],l=o.activeElement;c.shiftKey&&(l===m||!e.contains(l))?(c.preventDefault(),p.focus()):!c.shiftKey&&l===p&&(c.preventDefault(),m.focus())}e.addEventListener("keydown",i);let r=a();return r.length>0&&r[0].focus(),{release(){e.removeEventListener("keydown",i),n&&typeof n.focus=="function"&&n.focus()}}}function Z(e=typeof navigator<"u"?navigator:void 0){return e?e.globalPrivacyControl===!0:!1}var L="__cookieConsentInitialized";function ee(){return{necessary:!0,analytics:!0,functional:!0,marketing:!0}}function te(){return{necessary:!0,analytics:!1,functional:!1,marketing:!1}}function H(e){let o=window;if(o[L])return o[L];let t=z(e),n=t.honorGpc&&Z(),a=O(t),i=Y(t.theme),r=null,c=null,s=null,m=null;function p(){return{necessary:!0,analytics:t.categories.analytics?.enabled??!1,functional:t.categories.functional?.enabled??!1,marketing:n?!1:t.categories.marketing?.enabled??!1}}function l(x){a.write(x),F(t,x),f(),h(),b()}function C(){r||(r=$(t.labels,{onAcceptAll:()=>l(ee()),onRejectAll:()=>l(te()),onPreferences:v}),i.root.appendChild(r))}function f(){r?.remove(),r=null}function b(){c||(c=W(t.labels,v),i.root.appendChild(c))}function v(){if(s)return;let x=a.read()?.categories??p(),u=X(t,x,n,{onAcceptAll:()=>l(ee()),onRejectNonEssential:()=>l(te()),onSave:d=>l(d),onClose:h});s=u.overlay,i.root.appendChild(s),r&&(r.setAttribute("inert",""),r.setAttribute("aria-hidden","true")),m=Q(u.dialog,i.root,h)}function h(){m?.release(),m=null,s?.remove(),s=null,r&&(r.removeAttribute("inert"),r.removeAttribute("aria-hidden"))}a.needsPrompt()?C():b();let k={destroy(){h(),i.destroy(),delete o[L]},openPreferences:v,getConsent(){return a.read()?.categories??null}};return o[L]=k,k}function be(){if(typeof document>"u")return;let e=document.currentScript??document.querySelector("script[data-auto-init]");e&&e.hasAttribute("data-auto-init")&&H(K(e))}typeof window<"u"&&(window.CookieConsent={init:H},be());export{H as init};
