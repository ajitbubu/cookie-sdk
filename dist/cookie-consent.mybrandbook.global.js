"use strict";var CookieConsent=(()=>{var g={cookieName:"mybrandbook_consent",consentVersion:1,expiryDays:182,policyUrl:"https://www.mybrandbook.co.in/privacy-policy",honorGpc:!0,labels:{bannerText:"Privacy is our priority. We do not sell or otherwise share personal information for money or anything of value. We use strictly necessary cookies to enable site functionality and improve the performance of our website. We also store cookies to personalize the website content and to serve more relevant content to you. For more information, please visit our Privacy Policy or Cookie Policy."},theme:{"--cc-accent":"#DB2927"},gtm:{consentMode:!0,dataLayerEvent:"cookie_consent_update"},categories:{necessary:{enabled:!0,locked:!0,cookies:[{name:"mybrandbook_consent",provider:"mybrandbook.co.in",domain:"mybrandbook.co.in",purpose:"Stores your cookie choices",duration:"6 months"},{name:"session",provider:"mybrandbook.co.in",domain:"mybrandbook.co.in",purpose:"Keeps you signed in",duration:"Session"}]},analytics:{cookies:[{name:"_ga",provider:"Google Analytics",domain:"mybrandbook.co.in",purpose:"Distinguishes users",duration:"2 years"},{name:"_ga_*",provider:"Google Analytics",domain:"mybrandbook.co.in",purpose:"Persists session state",duration:"2 years"}]},functional:{cookies:[{name:"lang",provider:"mybrandbook.co.in",domain:"mybrandbook.co.in",purpose:"Remembers your language",duration:"1 year"}]},marketing:{cookies:[{name:"_fbp",provider:"Meta",domain:".mybrandbook.co.in",purpose:"Ad delivery & measurement",duration:"3 months"}]}}};var _={bannerText:"Privacy is our priority. We do not sell or otherwise share personal information for money or anything of value. We use strictly necessary cookies to enable site functionality and improve the performance of our website. We also store cookies to personalize the website content and to serve more relevant content to you. For more information, please visit our Privacy Policy or Cookie Policy.",acceptAll:"Accept All",rejectAll:"Reject All",preferences:"Preferences",modalTitle:"Cookie Preferences",rejectNonEssential:"Reject Non-Essential",savePreferences:"Save Preferences",reopenButton:"Cookie settings",alwaysActive:"Always Active",close:"Close",viewCookies:"View Cookies",backToCategories:"Back to categories",searchPlaceholder:"Search cookies...",exportLabel:"Export",printLabel:"Print",resetToDefault:"Reset to Default",confirmChoices:"Confirm Choices",policyLinkText:"Read our Cookie Policy",gpcNotice:"Your browser sent a Global Privacy Control (GPC) signal, so we have defaulted marketing and ad-targeting cookies to off. Strictly necessary cookies remain active to keep the site working. You may still review and enable optional analytics or functional cookies below, or leave them disabled \u2014 your choice is saved and can be changed at any time.",gpcHonored:"Opt-Out Request Honored",noCookies:"No cookies in this category.",notAvailable:"N/A",columns:{name:"Cookie",provider:"Provider",domain:"Domain",expiry:"Expiry"},categoryNames:{necessary:"Strictly Necessary Cookies",analytics:"Performance / Analytics",functional:"Functional Cookies",marketing:"Marketing Cookies"},categoryDescriptions:{necessary:"These cookies are essential for the website to function and cannot be switched off. They are usually only set in response to actions made by you, such as setting your privacy preferences.",analytics:"These cookies allow us to count visits and traffic sources so we can measure and improve site performance.",functional:"These cookies enable enhanced functionality and personalisation.",marketing:"These cookies are used to build a profile of your interests and show relevant ads. Covers sale or sharing of personal data where applicable."}},R=["necessary","analytics","functional","marketing"];function le(){return{necessary:{enabled:!0,locked:!0,cookies:[]},analytics:{enabled:!1,cookies:[]},functional:{enabled:!1,cookies:[]},marketing:{enabled:!1,cookies:[]}}}var E={cookieName:"cc_consent",consentVersion:1,expiryDays:182,honorGpc:!0,gtm:{consentMode:!0,dataLayerEvent:"cookie_consent_update"}};function P(e){let n={...le(),...e.categories||{}};n.necessary={...n.necessary,enabled:!0,locked:!0};let t=e.position??{};return{cookieName:e.cookieName??E.cookieName,cookieDomain:e.cookieDomain,consentVersion:e.consentVersion??E.consentVersion,expiryDays:e.expiryDays??E.expiryDays,policyUrl:e.policyUrl,honorGpc:e.honorGpc??E.honorGpc,position:{banner:t.banner??"bottom",button:t.button??"bottom-left"},categories:n,gtm:{...E.gtm,...e.gtm||{}},labels:{..._,...e.labels||{},columns:{..._.columns,...e.labels?.columns||{}},categoryNames:{..._.categoryNames,...e.labels?.categoryNames||{}},categoryDescriptions:{..._.categoryDescriptions,...e.labels?.categoryDescriptions||{}}},theme:e.theme,onConsent:e.onConsent}}var V={necessary:[],analytics:["analytics_storage"],functional:["functionality_storage","personalization_storage"],marketing:["ad_storage","ad_user_data","ad_personalization"]},M=["ad_storage","ad_user_data","ad_personalization","analytics_storage","functionality_storage","personalization_storage"];function D(e){let n={};for(let t of M)n[t]="denied";return Object.keys(V).forEach(t=>{if(e[t])for(let o of V[t])n[o]="granted"}),n}function de(e,n=document){let t=encodeURIComponent(e)+"=",o=n.cookie?n.cookie.split("; "):[];for(let r of o)if(r.indexOf(t)===0)return decodeURIComponent(r.slice(t.length));return null}function pe(e){if(!e)return null;let n;try{n=JSON.parse(e)}catch{return null}if(typeof n!="object"||n===null)return null;let t=n;if(t.schemaVersion!==1||typeof t.timestamp!="string"||typeof t.version!="number")return null;let o=t.categories;if(typeof o!="object"||o===null)return null;let r=["necessary","analytics","functional","marketing"];for(let i of r)if(typeof o[i]!="boolean")return null;return{schemaVersion:1,version:t.version,timestamp:t.timestamp,categories:{...o,necessary:!0}}}function S(e,n=document){return pe(de(e,n))}var H={};function me(e,n,t){return{schemaVersion:1,version:e.consentVersion,timestamp:t,categories:{...n,necessary:!0}}}function z(e,n=document,t=()=>new Date){function o(){return S(e.cookieName,n)??H[e.cookieName]??null}function r(a){let c=me(e,a,t().toISOString()),s=encodeURIComponent(JSON.stringify(c)),m=e.expiryDays*24*60*60,u=`${encodeURIComponent(e.cookieName)}=${s}; Max-Age=${m}; Path=/; SameSite=Lax`;e.cookieDomain&&(u+=`; Domain=${e.cookieDomain}`),typeof location<"u"&&location.protocol==="https:"&&(u+="; Secure");try{n.cookie=u,S(e.cookieName,n)===null&&(H[e.cookieName]=c,U())}catch{H[e.cookieName]=c,U()}return c}function i(){let a=o();return!a||a.version<e.consentVersion}return{read:o,write:r,needsPrompt:i}}var F=!1;function U(){!F&&typeof console<"u"&&(F=!0,console.warn("[cookie-banner-sdk] cookie write blocked; consent kept in memory for this session only."))}function W(){return typeof window<"u"?window:void 0}function $(e){return e.dataLayer=e.dataLayer||[],e.gtag||(e.gtag=function(){e.dataLayer.push(arguments)}),e.gtag}function Y(e,n=500,t=W()){if(!t)return;let o=$(t),r=e?D(e):M.reduce((i,a)=>(i[a]="denied",i),{});o("consent","default",{...r,wait_for_update:n})}function q(e,n){let t=W();e.gtm.consentMode&&t&&$(t)("consent","update",D(n)),e.gtm.consentMode&&t&&Array.isArray(t.dataLayer)&&t.dataLayer.push({event:e.gtm.dataLayerEvent,consent:{...n}}),typeof e.onConsent=="function"&&e.onConsent({...n})}function B(e){return`
  ...
  * { box-sizing: border-box; font-family: var(--cc-font); }
  ...
  `}function J(e){let n=document.createElement("div");n.setAttribute("data-cookie-consent-root","");let t=n.attachShadow({mode:"open"}),o=B(e),r=fe(t,o),i=null;return r||(i=document.createElement("style"),i.textContent=o,t.appendChild(i)),document.body.appendChild(n),{host:n,root:t,setTheme(a){let c=B(a);r?r.replaceSync(c):i&&(i.textContent=c)},destroy(){n.remove()}}}function fe(e,n){try{if(typeof CSSStyleSheet>"u"||typeof CSSStyleSheet.prototype.replaceSync!="function"||!("adoptedStyleSheets"in e))return null;let t=new CSSStyleSheet;return t.replaceSync(n),e.adoptedStyleSheets=[...e.adoptedStyleSheets,t],t}catch{return null}}function X(e,n){let t=document.createElement("div");t.className="cc-banner",t.setAttribute("role","dialog"),t.setAttribute("aria-label",e.modalTitle),t.setAttribute("aria-live","polite");let o=document.createElement("p");o.textContent=e.bannerText,t.appendChild(o);let r=document.createElement("div");r.className="cc-actions";let i=G(e.preferences,n.onPreferences,"cc-secondary"),a=G(e.rejectAll,n.onRejectAll,"cc-primary"),c=G(e.acceptAll,n.onAcceptAll,"cc-primary");return r.append(i,a,c),t.appendChild(r),t}function G(e,n,t){let o=document.createElement("button");return o.type="button",o.textContent=e,t&&(o.className=t),o.addEventListener("click",n),o}var I="http://www.w3.org/2000/svg";function ge(){let e=document.createElementNS(I,"svg");e.setAttribute("viewBox","0 0 24 24"),e.setAttribute("width","37"),e.setAttribute("height","37"),e.setAttribute("fill","#e02424"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","1.8"),e.setAttribute("aria-hidden","true");let n=document.createElementNS(I,"path");n.setAttribute("d","M12 2a10 10 0 1 0 10 10 4 4 0 0 1-4-4 4 4 0 0 1-4-4 2 2 0 0 0-2-2z"),e.appendChild(n);for(let[t,o]of[[9,9],[14,12],[10,15]]){let r=document.createElementNS(I,"circle");r.setAttribute("cx",String(t)),r.setAttribute("cy",String(o)),r.setAttribute("r","1"),r.setAttribute("fill","currentColor"),r.setAttribute("stroke","none"),e.appendChild(r)}return e}function Q(e,n){let t=document.createElement("button");return t.type="button",t.className="cc-fab",t.setAttribute("aria-label",e.reopenButton),t.title=e.reopenButton,t.appendChild(ge()),t.addEventListener("click",n),t}var Z="http://www.w3.org/2000/svg";function A(e,n={}){let t=document.createElementNS(Z,"svg");t.setAttribute("viewBox","0 0 24 24"),t.setAttribute("width","18"),t.setAttribute("height","18"),t.setAttribute("fill",n.fill?"currentColor":"none"),t.setAttribute("stroke",n.fill?"none":"currentColor"),t.setAttribute("stroke-width","1.8"),t.setAttribute("stroke-linecap","round"),t.setAttribute("stroke-linejoin","round"),t.setAttribute("aria-hidden","true");for(let o of e){let r=document.createElementNS(Z,"path");r.setAttribute("d",o),t.appendChild(r)}return t}var L={gear:()=>A(["M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z","M19.4 13.5a1.7 1.7 0 0 0 .3 1.9l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.7 1.7 0 0 0-2.9 1.2V21a2 2 0 0 1-4 0v-.2a1.7 1.7 0 0 0-2.9-1.1l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.7 1.7 0 0 0-1.2-2.9H3a2 2 0 0 1 0-4h.2a1.7 1.7 0 0 0 1.1-2.9l-.1-.1A2 2 0 1 1 7 4.2l.1.1a1.7 1.7 0 0 0 1.9.3 1.7 1.7 0 0 0 1-1.6V3a2 2 0 0 1 4 0v.2a1.7 1.7 0 0 0 1 1.5 1.7 1.7 0 0 0 1.9-.3l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1H21a2 2 0 0 1 0 4h-.2a1.7 1.7 0 0 0-1.4 1z"]),check:()=>A(["M20 6 9 17l-5-5"]),back:()=>A(["M19 12H5","M12 19l-7-7 7-7"]),exportIcon:()=>A(["M12 3v12","M8 7l4-4 4 4","M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"]),print:()=>A(["M6 9V2h12v7","M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2","M6 14h12v8H6z"])};function te(e,n,t,o){let r=e.labels,i={},a=document.createElement("div");a.className="cc-overlay",a.addEventListener("click",p=>{p.target===a&&o.onClose()});let c=document.createElement("div");c.className="cc-modal",c.setAttribute("role","dialog"),c.setAttribute("aria-modal","true"),c.setAttribute("aria-label",r.modalTitle);let s=document.createElement("div");s.className="cc-modal-header";let m=document.createElement("div");m.className="cc-title",m.append(L.gear(),C("h2",r.modalTitle));let u=document.createElement("button");u.type="button",u.className="cc-close",u.setAttribute("aria-label",r.close),u.append(C("span","\u2715","cc-close-x")),u.addEventListener("click",o.onClose),s.append(m,u),c.appendChild(s);let d=document.createElement("div");if(d.className="cc-panel cc-panel-categories",t){let p=document.createElement("p");if(p.className="cc-gpc-notice",p.textContent=r.gpcNotice+" ",e.policyUrl){let f=document.createElement("a");f.href=e.policyUrl,f.target="_blank",f.rel="noopener",f.textContent=r.policyLinkText,p.appendChild(f)}d.appendChild(p);let l=document.createElement("div");l.className="cc-gpc-honored",l.setAttribute("role","status"),l.append(L.check(),C("span",r.gpcHonored)),d.appendChild(l)}else if(e.policyUrl){let p=document.createElement("p");p.className="cc-gpc-notice",p.textContent=r.bannerText+" ";let l=document.createElement("a");l.href=e.policyUrl,l.target="_blank",l.rel="noopener",l.textContent=r.policyLinkText,p.appendChild(l),d.appendChild(p)}for(let p of R){let l=e.categories[p];l&&d.appendChild(be(p,l,e,n,i,w))}c.appendChild(d);let h=document.createElement("div");h.className="cc-panel cc-panel-detail",h.hidden=!0,c.appendChild(h);let b=document.createElement("div");b.className="cc-modal-actions",b.append(N(r.rejectNonEssential,o.onRejectNonEssential,"cc-secondary"),N(r.acceptAll,o.onAcceptAll,"cc-primary"),N(r.savePreferences,()=>o.onSave(x()),"cc-primary")),c.appendChild(b);let y=document.createElement("div");y.className="cc-modal-actions",y.hidden=!0,y.append(N(r.resetToDefault,v,"cc-secondary"),N(r.confirmChoices,()=>o.onSave(x()),"cc-primary")),c.appendChild(y);function x(){return{necessary:!0,analytics:i.analytics?.checked??!1,functional:i.functional?.checked??!1,marketing:i.marketing?.checked??!1}}function v(){Object.keys(i).forEach(p=>{let l=i[p];l&&(l.checked=e.categories[p]?.enabled??!1)})}function k(){h.hidden=!0,y.hidden=!0,d.hidden=!1,b.hidden=!1}function w(p){h.replaceChildren(he(p,e,k)),d.hidden=!0,b.hidden=!0,h.hidden=!1,y.hidden=!1}return a.appendChild(c),{overlay:a,dialog:c}}function be(e,n,t,o,r,i){let a=t.labels,c=document.createElement("div");c.className="cc-card";let s=document.createElement("div");if(s.className="cc-card-head",s.appendChild(C("h3",a.categoryNames[e])),n.locked){let d=document.createElement("span");d.className="cc-badge",d.textContent=a.alwaysActive,s.appendChild(d)}else s.appendChild(ye(e,o[e],a.categoryNames[e],r));c.appendChild(s);let m=document.createElement("p");m.className="cc-card-desc",m.textContent=n.description??a.categoryDescriptions[e],c.appendChild(m);let u=document.createElement("button");return u.type="button",u.className="cc-view-link",u.textContent=a.viewCookies,u.addEventListener("click",()=>i(e)),c.appendChild(u),c}function ye(e,n,t,o){let r=document.createElement("label");r.className="cc-switch";let i=document.createElement("input");i.type="checkbox",i.checked=n,i.setAttribute("aria-label",t);let a=document.createElement("span");return a.className="cc-slider",r.append(i,a),o[e]=i,r}function he(e,n,t){let o=n.labels,r=n.categories[e],i=document.createElement("div"),a=document.createElement("button");a.type="button",a.className="cc-back",a.append(L.back(),C("span",o.backToCategories)),a.addEventListener("click",t),i.appendChild(a),i.appendChild(C("h3",o.categoryNames[e],"cc-detail-title")),i.appendChild(C("p",r.description??o.categoryDescriptions[e],"cc-detail-desc"));let c=document.createElement("div");c.className="cc-toolbar";let s=document.createElement("input");s.type="search",s.className="cc-search",s.placeholder=o.searchPlaceholder,s.setAttribute("aria-label",o.searchPlaceholder);let m=ee(o.exportLabel,L.exportIcon(),()=>ve(e,n)),u=ee(o.printLabel,L.print(),()=>xe(e,n));c.append(s,m,u),i.appendChild(c);let d=document.createElement("table");d.className="cc-table";let h=document.createElement("thead"),b=document.createElement("tr");[o.columns.name,o.columns.provider,o.columns.domain,o.columns.expiry].forEach(k=>b.appendChild(C("th",k))),h.appendChild(b);let y=document.createElement("tbody");function x(k){y.replaceChildren();let w=k.trim().toLowerCase(),p=r.cookies.filter(l=>!w||[l.name,l.provider,l.domain,l.purpose].some(f=>(f||"").toLowerCase().includes(w)));if(p.length===0){let l=document.createElement("tr"),f=C("td",n.labels.noCookies);f.setAttribute("colspan","4"),f.className="cc-empty-row",l.appendChild(f),y.appendChild(l);return}for(let l of p){let f=document.createElement("tr");f.append(C("td",l.name,"cc-cell-name"),C("td",l.provider||o.notAvailable),C("td",l.domain||o.notAvailable),C("td",l.duration||o.notAvailable)),y.appendChild(f)}}x(""),s.addEventListener("input",()=>x(s.value)),d.append(h,y);let v=document.createElement("div");return v.className="cc-table-scroll",v.appendChild(d),i.appendChild(v),i}function Ce(e,n){let t=n.labels,o=[t.columns.name,t.columns.provider,t.columns.domain,t.columns.expiry,"Purpose"],r=a=>`"${String(a).replace(/"/g,'""')}"`,i=[o.map(r).join(",")];for(let a of n.categories[e].cookies)i.push([a.name,a.provider||t.notAvailable,a.domain||t.notAvailable,a.duration||t.notAvailable,a.purpose||t.notAvailable].map(r).join(","));return i.join(`
`)}function ve(e,n){try{let t=new Blob([Ce(e,n)],{type:"text/csv;charset=utf-8"}),o=URL.createObjectURL(t),r=document.createElement("a");r.href=o,r.download=`cookies-${e}.csv`,r.click(),URL.revokeObjectURL(o)}catch{}}function xe(e,n){let t=n.labels,o=window.open("","_blank","width=720,height=600");if(!o)return;let r=o.document;r.title=`${t.categoryNames[e]} \u2014 cookies`;let i=r.createElement("h2");i.textContent=t.categoryNames[e];let a=r.createElement("table");a.setAttribute("border","1"),a.style.borderCollapse="collapse";let c=r.createElement("thead"),s=r.createElement("tr");[t.columns.name,t.columns.provider,t.columns.domain,t.columns.expiry].forEach(u=>{let d=r.createElement("th");d.textContent=u,d.style.padding="6px 10px",s.appendChild(d)}),c.appendChild(s);let m=r.createElement("tbody");for(let u of n.categories[e].cookies){let d=r.createElement("tr");[u.name,u.provider||t.notAvailable,u.domain||t.notAvailable,u.duration||t.notAvailable].forEach(h=>{let b=r.createElement("td");b.textContent=h,b.style.padding="6px 10px",d.appendChild(b)}),m.appendChild(d)}a.append(c,m),r.body.append(i,a),o.focus(),o.print()}function C(e,n,t){let o=document.createElement(e);return o.textContent=n,t&&(o.className=t),o}function N(e,n,t){let o=document.createElement("button");return o.type="button",o.textContent=e,t&&(o.className=t),o.addEventListener("click",n),o}function ee(e,n,t){let o=document.createElement("button");return o.type="button",o.className="cc-icon-btn",o.append(n,C("span",e)),o.addEventListener("click",t),o}var ke='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';function oe(e,n,t){let o=n.activeElement;function r(){return Array.from(e.querySelectorAll(ke)).filter(c=>c.offsetParent!==null||c===n.activeElement)}function i(c){if(c.key==="Escape"){c.preventDefault(),t();return}if(c.key!=="Tab")return;let s=r();if(s.length===0){c.preventDefault();return}let m=s[0],u=s[s.length-1],d=n.activeElement;c.shiftKey&&(d===m||!e.contains(d))?(c.preventDefault(),u.focus()):!c.shiftKey&&d===u&&(c.preventDefault(),m.focus())}e.addEventListener("keydown",i);let a=r();return a.length>0&&a[0].focus(),{release(){e.removeEventListener("keydown",i),o&&typeof o.focus=="function"&&o.focus()}}}function j(e=typeof navigator<"u"?navigator:void 0){return e?e.globalPrivacyControl===!0:!1}var T="__cookieConsentInitialized",we=new Set(["--cc-bg","--cc-fg","--cc-muted","--cc-border","--cc-surface","--cc-accent","--cc-accent-fg","--cc-success","--cc-success-bg","--cc-success-border","--cc-radius","--cc-font","--cc-font-size","--cc-heading-color","--cc-heading-size","--cc-z"]);function K(e){console.warn(`[cookie-banner-sdk] ${e} See https://github.com/ajitbubu/cookie-sdk#configuration`)}function Ee(e,n){let t=["analytics","functional","marketing"].filter(o=>(n.categories[o]?.cookies?.length??0)>0);(!e.categories||t.length===0)&&K("no optional cookie categories are configured \u2014 the preferences modal will only show 'Strictly Necessary'. Pass `categories` with the cookies your site sets.");for(let o of Object.keys(n.theme??{})){let r=o.startsWith("--cc-")?o:`--cc-${o.replace(/^--/,"")}`;we.has(r)||K(`theme key "${o}" is not a recognized --cc-* variable and will have no effect.`)}}function ne(){return{necessary:!0,analytics:!0,functional:!0,marketing:!0}}function re(){return{necessary:!0,analytics:!1,functional:!1,marketing:!1}}function ae(e){let n=window;if(n[T])return K("init() called more than once \u2014 ignoring this call and returning the existing instance. Call destroy() first if you mean to re-initialize."),n[T];let t=P(e);Ee(e,t);let o=t.honorGpc&&j(),r=z(t),i=J(t.theme),a=null,c=null,s=null,m=null;function u(){return{necessary:!0,analytics:t.categories.analytics?.enabled??!1,functional:t.categories.functional?.enabled??!1,marketing:o?!1:t.categories.marketing?.enabled??!1}}function d(p){r.write(p),q(t,p),b(),v(),y()}function h(p=!0){a||(a=X(t.labels,{onAcceptAll:()=>d(ne()),onRejectAll:()=>d(re()),onPreferences:x}),a.classList.add(`cc-pos-${t.position.banner}`),p||a.classList.add("cc-no-anim"),i.root.appendChild(a))}function b(){a?.remove(),a=null}function y(){c||(c=Q(t.labels,x),c.classList.add(`cc-fab-${t.position.button}`),i.root.appendChild(c))}function x(){if(s)return;let p=r.read()?.categories??u(),l=te(t,p,o,{onAcceptAll:()=>d(ne()),onRejectNonEssential:()=>d(re()),onSave:f=>d(f),onClose:v});s=l.overlay,i.root.appendChild(s),a&&(a.setAttribute("inert",""),a.setAttribute("aria-hidden","true")),m=oe(l.dialog,i.root,v)}function v(){m?.release(),m=null,s?.remove(),s=null,a&&(a.removeAttribute("inert"),a.removeAttribute("aria-hidden"))}r.needsPrompt()?h():y();function k(p){t=P(p),o=t.honorGpc&&j(),r=z(t),i.setTheme(t.theme);let l=!!s;v(),b(),c?.remove(),c=null,r.needsPrompt()?h(!1):y(),l&&x()}let w={destroy(){v(),i.destroy(),delete n[T]},openPreferences:x,getConsent(){return r.read()?.categories??null},update:k};return n[T]=w,w}function O(e={},n=typeof document<"u"?document:void 0){let t=e.cookieName??"cc_consent",o=e.waitForUpdate??500,r=n?S(t,n):null;Y(r?r.categories:null,o)}typeof window<"u"&&O(window.CC_BOOTSTRAP||{});var Se="cookie-settings",ie=typeof g<"u"?g:{cookieName:"cc_consent",consentVersion:1,expiryDays:182,honorGpc:!0,gtm:{consentMode:!0,dataLayerEvent:"cookie_consent_update"},theme:{"--cc-accent":"#DB2927"}};O({cookieName:ie.cookieName});function ce(){let e=ae(ie),n=window;n.cookieConsent=e,n.faceoffConsent=e;let t=document.getElementById(Se);t&&t.addEventListener("click",o=>{o.preventDefault(),e.openPreferences()})}typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ce):ce());})();
